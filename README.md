...
* 🔒 **Privacy-First** – Files are processed in-browser when possible.
* ⚡ **Fast & Efficient** – Optimized for performance.
* 📱 **Mobile-Optimized** – Fully responsive UI.
* 🎨 **Modern UI** – Sleek, intuitive design.
* 🔧 **Open Source** – Built for developers, extensible by anyone.
...
* ✅ **Local Processing**: Files never leave your browser unless needed
* 🚫 **No File Storage**: We don’t store your uploads
* 📉 **Minimal Analytics**: Anonymous, opt-out friendly
...
* 🌐 [Try Ztooly](https://ztooly.netlify.app/)
